        ...
        <ul className="space-y-2">
          <li>
            <Link 
              ...
              className={`flex items-center gap-3 py-2 px-3 rounded-lg transition-colors duration-200 ${
                pathname === '/' ? 'bg-sky-600 text-white' : 'hover:bg-sky-600 hover:text-white'
              }`}
            >
          ...
          <li>
            <Link 
              ...
              className={`flex items-center gap-3 py-2 px-3 rounded-lg transition-colors duration-200 ${
                pathname === '/crisismanagement' ? 'bg-sky-600 text-white' : 'hover:bg-sky-600 hover:text-white'
              }`}
            >
          ...
          <li>
            <Link 
              ...
              className={`flex items-center gap-3 py-2 px-3 rounded-lg transition-colors duration-200 ${
                pathname === '/whatifsimulations' ? 'bg-sky-600 text-white' : 'hover:bg-sky-600 hover:text-white'
              }`}
            >
          ...
          <li>
            <Link 
              href="/auditlogs" 
              className={`flex items-center gap-3 py-2 px-3 rounded-lg transition-colors duration-200 ${
                pathname === '/auditlogs' ? 'bg-sky-600 text-white' : 'hover:bg-sky-600 hover:text-white'
              }`}
            >
           ...
           <li>
            <Link 
              href="/kpiboard" 
              className={`flex items-center gap-3 py-2 px-3 rounded-lg transition-colors duration-200 ${
                pathname === '/kpiboard' ? 'bg-sky-600 text-white' : 'hover:bg-sky-600 hover:text-white'
              }`}
            >
          ...
          <li>
            <Link 
              href="/chatassistant" 
              className={`flex items-center gap-3 py-2 px-3 rounded-lg transition-colors duration-200 ${
                pathname === '/chatassistant' ? 'bg-sky-600 text-white' : 'hover:bg-sky-600 hover:text-white'
              }`}
            >
