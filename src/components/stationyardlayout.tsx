...
const SIGNAL_CONFIG: Signal[] = [
  ...
  { id: 'Outer_Warner_UP', state: 'green', connectedTo: ['upMain_1', 'upMain_2'] },
  { id: 'Home_UP', state: 'red', connectedTo: ['upMain_2', 'upMain_3'] },
  { id: 'Loop_Starter_DN', state: 'green', connectedTo: ['upTurnout_1_Diverge','commonLoop'] },
  { id: 'Loop_Starter_UP', state: 'red', connectedTo: ['commonLoop', 'upTurnout_2_Diverge'] },
  { id: 'Starter_UP', state: 'green', connectedTo: ['stopMainUP','upMain_5'] },
  { id: 'Adv_Starter_UP', state: 'red', connectedTo: ['upMain_6', 'upMain_7'] },

  { id: 'Outer_Warner_DN', state: 'red', connectedTo: ['dnMain_2', 'dnMain_1'] },
  { id: 'Home_DN', state: 'green', connectedTo: ['dnMain_Turnout1_Straight','dnMain_2'] },
  { id: 'Loop_Starter', state: 'red', connectedTo: ['dnTurnout_1_Diverge', 'sideLoop'] },
...
const LAYOUT_CONFIG: TrackSegment[] = [
  ...
  { id: 'upMain_5', d: 'M 700 150 L 800 150', connectedTo: ['upMain_Turnout2_Straight'] },
  { id: 'upMain_6', d: 'M 900 150 L 1000 150', connectedTo: ['upMain_7'] },
  { id: 'upMain_7', d: 'M 1000 150 L 1100 150', connectedTo: ['upMain_8'] },
  { id: 'upMain_8', d: 'M 1100 150 L 1200 150', connectedTo: [''], isBlock: true },
  // DN Main Line
  { id: 'dnMain_6', d: 'M 0 250 L 100 250', connectedTo: ['dnMain_5'], isBlock: true },
  { id: 'dnMain_5', d: 'M 100 250 L 200 250', connectedTo: ['dnMain_Turnout2_Straight'] },
  { id: 'dnMain_4', d: 'M 400 250 L 500 250', connectedTo: ['stopMainDN'] },
  { id: 'stopMainDN', d: 'M 500 250 L 700 250', connectedTo: ['dnMain_3'] },
  { id: 'dnMain_3', d: 'M 700 250 L 800 250', connectedTo: ['dnMain_Turnout1_Straight'] },
  ...
  { id: 'upMain_Turnout2_Straight', d: 'M 800 150 L 900 150', connectedTo: ['upTurnout_2_Diverge','up_down_2_Diverge','upMain_6'] },
...
const StationYardLayout = () => {
  ...
  const [t1, t2] = signal.connectedTo.map(id => LAYOUT_CONFIG.find(t => t.id === id));
  ...
  return (
    <g key={signal.id} transform={`translate(${joinX}, ${joinY - poleHeight})`}>
